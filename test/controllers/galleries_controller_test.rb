...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { cover_image: @gallery.cover_image, name: @gallery.name } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { cover_image: @gallery.cover_image, name: @gallery.name } }
